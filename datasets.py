...
def get_dataset(dataset_name, target_folder="./", datasets=DATASETS_CONFIG):
    ...
    if dataset_name == "PaviaC":
    ...
    elif "Salinas" in dataset_name:
        gt = open_file('Datasets/Salinas/Salinas_gt.mat')["salinas_gt"]
        label_values = [
            "Undefined",
        ...
        ds_suff = re.split('(Salinas)', dataset_name)[2]
        ...
        if ds_suff == '': # Raw dataset
            ...
            img = open_file(f"Datasets/Salinas/{dataset_name}.mat")["data"]
            print(f'Using {dataset_name} dataset with shape {img.shape}')
            rgb_bands = None 
